...
#
# USAGE:
#   ./1.Data_Generation_DFT liquid             # Run liquid phase only
#   ./1.Data_Generation_DFT solid             # Run solid phase only
#   ./1.Data_Generation_DFT both               # Run both liquid and solid phases
#
# WORKFLOW:
#   Liquid: High-T equilibration (TL) → Melting temperature (TM)
#   Solid:  Melting temperature (TM) Equilibration → Melting temperature (TM)
#
